...
export default function SocialShare({ url, title, description, className = "justify-center" }: SocialShareProps) {
  ...
  const shareData = {
    ...
    hashtags: encodeURIComponent('Venezolario,Venezuela,Spanish,Language,Culture')
  }

  const shareLinks = {
    x: `https://x.com/intent/tweet?text=${shareData.title}&url=${shareData.url}&hashtags=${shareData.hashtags}`,
